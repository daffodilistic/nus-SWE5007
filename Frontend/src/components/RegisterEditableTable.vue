  ...
  <article>
    ...
    <div class="action-container">
      <table align="right">
        <tr>
          <td>
            <b-button class="custom-button" @click="addRowHandler"><b-icon icon="person-plus" ></b-icon></b-button>
          </td>
        </tr>
      </table>
    </div>
...
export default {
  ...
  methods: {
    ...
    handleCountrySelect(index) {
      ...
      this.selectedCountry = this.categories.find(
...
.custom-button {
  background-color: rgb(65, 127, 202); /* Your custom background color */
