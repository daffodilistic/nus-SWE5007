  ...
  <div id="app">
    <div class="form-container">
      <div class="form-group">
        ...
        <label><i class="far fa-id-card" style='color: rgb(65, 127, 202)'></i> <label class="red-asterisk">*</label>Team Name:</label>
        <input v-model="teamName" type="text" placeholder="Enter Team Name" />
      </div>
      <div class="form-group select">
        <label><i class="fas fa-user-tag" style='color: rgb(65, 127, 202)'></i> <label class="red-asterisk">*</label>Age Group:</label>
        <select v-model="ageGroup" id="category">
      ...
      <div class="form-group select">
        ...
        <label><i class="fas fa-trophy" style='color: rgb(65, 127, 202)'></i> <label class="red-asterisk">*</label>Competition Choice:</label>
        <select v-model="competitionChoice" id="category">
          <option value="">Select Competition Choice</option>
